...
module Battle::Scene::Animation::BallAnimationMixin
  ...
  BALL_BURST_VARIANCES = {
    ...
    :POKEBALL    => [Tone.new(0, 0, 0), Tone.new(0, 0, -192),   # White, yellow
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(0, 0, -96), Tone.new(0, -128, -248),   # Yellow, dark orange
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(0, 0, -96), Tone.new(0, 0, -192)],   # Light yellow, yellow
    :GREATBALL   => [Tone.new(0, 0, 0), Tone.new(-128, -64, 0),   # White, blue
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(-128, 0, 0), Tone.new(-248, -64, 0),   # Cyan, dark cyan
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(-96, -48, 0),   # White, light blue
                     "ballBurst_particle", Tone.new(-96, -48, 0), Tone.new(-192, -96, 0)],   # Blue, dark blue
    :SAFARIBALL  => [Tone.new(0, 0, -32), Tone.new(-128, 0, -128),   # Pale yellow, green
                     "ballBurst_particle", Tone.new(0, 0, -64), Tone.new(-160, 0, -160),   # Beige, darker green
                     "ballBurst_particle", Tone.new(0, 0, -64), Tone.new(-160, 0, -160),   # Beige, darker green
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(-80, 0, -80),   # White, light green
                     "ballBurst_particle", Tone.new(-32, 0, -96), Tone.new(-160, 0, -160)],   # Pale green, darker green
    :ULTRABALL   => [Tone.new(0, 0, 0), Tone.new(0, 0, -192),   # White, yellow
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(0, 0, -64), Tone.new(0, 0, -224),   # Pale yellow, yellow
                     "ballBurst_dazzle", Tone.new(0, 0, 0), Tone.new(0, 0, -128),   # White, light yellow
                     "ballBurst_particle", Tone.new(0, 0, -64), Tone.new(0, 0, -224)],   # Pale yellow, yellow
    :MASTERBALL  => [Tone.new(0, 0, 0), Tone.new(-48, -200, -56),   # White, magenta
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(-48, -200, -56),   # White, magenta
                     "ballBurst_dazzle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_dazzle", Tone.new(-48, -200, -56), Tone.new(-48, -200, -56)],   # Magenta, magenta
    :NETBALL     => [Tone.new(0, 0, 0), Tone.new(0, -64, 0),   # White, lilac
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, -64, 0),   # White, lilac
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, -64, 0),   # White, lilac
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, -64, 0),   # White, lilac
    ...
    :DIVEBALL    => [Tone.new(0, 0, 0), Tone.new(-192, -128, -32),   # White, dark blue
                     ...
                     "ballBurst_particle", Tone.new(-184, -40, 0), Tone.new(-184, -40, 0),   # Cyan, cyan
                     "ballBurst_dazzle", Tone.new(-184, -40, 0), Tone.new(-184, -40, 0),   # Cyan, cyan
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(-184, -40, 0)],   # White, cyan
    :NESTBALL    => [Tone.new(0, 0, 0), Tone.new(0, 0, -192),   # White, yellow
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(0, 0, -96), Tone.new(0, -128, -248),   # Light yellow, dark orange
                     "ballBurst_dazzle", Tone.new(0, 0, 0), Tone.new(-96, 0, -96),   # White, green
                     "ballBurst_particle", Tone.new(-96, 0, -96), Tone.new(-192, 0, -192)],   # Green, dark green
    :REPEATBALL  => [Tone.new(0, 0, 0), Tone.new(0, 0, -192),   # White, yellow
                     "circle wave", Tone.new(-16, -16, -88), Tone.new(-32, -32, -176),   # Yellow, yellow
                     "ballBurst_particle", Tone.new(-144, -144, -144), Tone.new(-160, -160, -160),   # Grey, grey
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(0, -128, -248), Tone.new(0, -128, -248)],   # Dark orange, dark orange
    ...
    :LUXURYBALL  => [Tone.new(0, 0, 0), Tone.new(0, -128, -160),   # White, orange
                     ...
                     "ballBurst_particle", Tone.new(0, 0, -96), Tone.new(0, -128, -248),   # Yellow, dark orange
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(0, -64, -144), Tone.new(0, -192, -248)],   # Light orange, red
    :PREMIERBALL => [Tone.new(0, -160, -148), Tone.new(0, 0, 0),   # Red, white
                     "ballBurst_particle", Tone.new(0, -192, -152), Tone.new(0, -192, -152),   # Red, red
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, -192, -152),   # White, red
                     "ballBurst_dazzle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0)],   # White, white
    :DUSKBALL    => [Tone.new(-48, -200, -56), Tone.new(-160, -224, -160),   # Magenta, dark purple
                     "ballBurst_particle", Tone.new(-248, -248, -248), Tone.new(-248, -248, -248),   # Black, black
                     "ballBurst_particle", Tone.new(-24, -96, -32), Tone.new(-24, -96, -32),   # Light magenta, light magenta
                     "ballBurst_particle", Tone.new(-248, -248, -248), Tone.new(-248, -248, -248),   # Black, black
    ...
    :HEALBALL    => [Tone.new(-8, -48, -8), Tone.new(-16, -128, -112),   # Pink, dark pink
                     ...
                     "ballBurst_dazzle", Tone.new(0, 0, 0), Tone.new(-32, -112, -80),   # White, magenta
                     "ballBurst_particle", Tone.new(-8, -48, -8), Tone.new(-64, -224, -160)],   # Pink, dark magenta
    :QUICKBALL   => [Tone.new(-64, 0, 0), Tone.new(-192, -96, 0),   # Light cyan, dark blue
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(0, 0, -96), Tone.new(0, -128, -248),   # Yellow, dark orange
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(-96, 0, 0), Tone.new(-192, -96, 0)],   # Cyan, dark blue
    :CHERISHBALL => [Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white (unused; see below)
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, -192),   # White ,yellow
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(0, 0, -96), Tone.new(0, 0, -192)]   # Light yellow, yellow
  }
  ...
  def ballBurst(delay, ball, ballX, ballY, poke_ball)
    ...
    glare1 = addNewSprite(ballX, ballY, "Graphics/Battle animations/#{variances[11]}", PictureOrigin::CENTER)
    glare2 = addNewSprite(ballX, ballY, "Graphics/Battle animations/#{variances[8]}", PictureOrigin::CENTER)
    ...
    elsif ["vortex 2"].include?(variances[11])
      glare1.moveZoom(delay, glare_fade_duration, 200)
    else
      glare1.moveZoom(delay, glare_fade_duration, (["ballBurst_dazzle", "circle wave", "web"].include?(variances[11])) ? 100 : 250)
    end
    ...
    if poke_ball == :MASTERBALL
      ...
      glare2.moveZoom(delay, glare_fade_duration, (["ballBurst_dazzle", "circle wave", "web"].include?(variances[8])) ? 125 : 200)
    end
    ...
    num_particles.times do |i|
      # Set up particles
      particle1 = addNewSprite(ballX, ballY, "Graphics/Battle animations/#{variances[5]}", PictureOrigin::CENTER)
      particle2 = addNewSprite(ballX, ballY, "Graphics/Battle animations/#{variances[2]}", PictureOrigin::CENTER)
      [particle1, particle2].each_with_index do |particle, num|
        particle.setZ(0, 5110 + num)
        particle.setZoom(0, (80 - (num * 20)) / (["circle 2"].include?(variances[5 - (3 * num)]) ? 2 : 1))
  ...
  BALL_BURST_CAPTURE_VARIANCES = {
    ...
    :POKEBALL    => ["ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_dazzle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, -192),   # White, yellow
                     "ballBurst_particle_s", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle_s", Tone.new(0, 0, 0), Tone.new(0, 0, -192),   # White, yellow
                     Tone.new(0, 0, -96), Tone.new(0, 0, -96)],   # Light yellow, light yellow
    :GREATBALL   => ["ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_dazzle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, -192),   # White, yellow
                     "ballBurst_particle_s", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle_s", Tone.new(0, 0, 0), Tone.new(-128, -64, 0),   # White, blue
                     Tone.new(-128, -32, 0), Tone.new(-128, -32, 0)],   # Blue, blue
    :SAFARIBALL  => ["ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_dazzle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, -192),   # White, yellow
                     "ballBurst_particle_s", Tone.new(-48, 0, -48), Tone.new(-48, 0, -48),   # Light green, light green
                     "ballBurst_particle_s", Tone.new(-48, 0, -48), Tone.new(-128, 0, -128),   # Light green, green
                     Tone.new(-48, 0, -48), Tone.new(-128, 0, -128)],   # Light green, green
    :ULTRABALL   => ["ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_dazzle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, -192),   # White, yellow
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_dazzle", Tone.new(0, 0, 0), Tone.new(0, 0, -192),   # White, yellow
                     Tone.new(0, 0, -128), Tone.new(0, 0, -128)],   # Light yellow, light yellow
    :MASTERBALL  => ["ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_dazzle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(-64, -128, -64), Tone.new(-96, -160, -96),   # Purple, darker purple
                     "ballBurst_dazzle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(0, -80, 0), Tone.new(0, -128, -64),   # Purple, hot pink
                     Tone.new(0, 0, 0), Tone.new(-48, -200, -80)],   # White, magenta
    :NETBALL     => ["ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_dazzle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, -192),   # White, yellow
                     "ballBurst_particle_s", Tone.new(-128, -56, 0), Tone.new(-128, -56, 0),   # Blue, blue
                     "ballBurst_particle_s", Tone.new(-128, -56, 0), Tone.new(-128, -56, 0),   # Blue, blue
                     Tone.new(-160, -64, 0), Tone.new(-128, -56, 0)],   # Cyan, blue
    :DIVEBALL    => ["ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_dazzle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, -192),   # White, yellow
                     "bubble 1", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(-128, -48, 0), Tone.new(-128, -48, 0),   # Aqua, aqua
                     Tone.new(-64, 0, 0), Tone.new(-180, -32, -32)],   # Light blue, turquoise
    :NESTBALL    => ["ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_dazzle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, -192),   # White, yellow
                     ...
                     Tone.new(-48, 0, -48), Tone.new(-128, 0, -128)],   # Light green, green
    :REPEATBALL  => ["ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_dazzle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, -192),   # White, yellow
                     "circle wave", Tone.new(-16, -16, -88), Tone.new(-32, -32, -176),   # Yellow, yellow
                     "ballBurst_particle", Tone.new(-144, -144, -144), Tone.new(-160, -160, -160),   # Grey, grey
                     Tone.new(0, 0, -96), Tone.new(0, 0, -96)],   # Light yellow, light yellow
    :TIMERBALL   => ["ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_dazzle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, -192),   # White, yellow
                     "ballBurst_particle_s", Tone.new(0, 0, 0), Tone.new(0, 0, -96),   # White, light yellow
                     "ballBurst_particle_s", Tone.new(0, -48, -160), Tone.new(0, 0, -96),   # Orange, light yellow
                     Tone.new(0, -48, -128), Tone.new(0, -160, -248)],   # Light orange, dark orange
    :LUXURYBALL  => ["ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_dazzle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, -192, -248),   # White, red
                     "ballBurst_particle_s", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle_s", Tone.new(0, 0, 0), Tone.new(0, 0, -192),   # White, yellow
                     Tone.new(0, -48, -128), Tone.new(0, -192, -248)],   # Light orange, red
    :PREMIERBALL => ["ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_dazzle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "circle faded", Tone.new(-16, -40, -80), Tone.new(-16, -136, -176),   # Light orange, dark orange
                     Tone.new(0, 0, 0), Tone.new(0, 0, 0)],   # White, white
    :DUSKBALL    => ["ballBurst_particle", Tone.new(-255, -255, -255), Tone.new(-255, -255, -255),   # Black, black
                     ...
                     "ballBurst_particle", Tone.new(-112, -184, -128), Tone.new(-255, -255, -255),   # Purple, black
                     "ballBurst_particle_s", Tone.new(-112, -184, -128), Tone.new(-255, -255, -255),   # Purple, black
                     Tone.new(0, 0, -96), Tone.new(0, 0, -96)],   # Light yellow, light yellow
    :HEALBALL    => ["ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_dazzle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(0, -32, 0), Tone.new(0, -32, 0),   # Light pink, light pink
                     "shine 3", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "shine 3", Tone.new(0, 0, 0), Tone.new(-160, -64, 0),   # White, cyan
                     Tone.new(0, 0, 0), Tone.new(0, -32, 0)],   # White, light pink
    :QUICKBALL   => ["ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_dazzle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, -192),   # White, yellow
                     "ballBurst_particle_s", Tone.new(0, 0, 0), Tone.new(0, 0, -96),   # White, light yellow
                     "ballBurst_particle_s", Tone.new(0, -48, -160), Tone.new(0, 0, -96),   # Orange, light yellow
                     Tone.new(0, -48, -128), Tone.new(0, -160, -248)],   # Light orange, dark orange
    :CHERISHBALL => ["ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_dazzle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "ballBurst_particle", Tone.new(0, 0, 0), Tone.new(0, 0, 0),   # White, white
                     "circle faded", Tone.new(-16, -40, -80), Tone.new(-16, -136, -176),   # Light orange, dark orange
  ...
  def ballBurstCapture(delay, ball, ballX, ballY, poke_ball)
    ...
    # Set up glare particles
    glare1 = addNewSprite(ballX, ballY, "Graphics/Battle animations/#{variances[6]}", PictureOrigin::CENTER)
    glare2 = addNewSprite(ballX, ballY, "Graphics/Battle animations/#{variances[3]}", PictureOrigin::CENTER)
    glare3 = addNewSprite(ballX, ballY, "Graphics/Battle animations/#{variances[0]}", PictureOrigin::CENTER)
    ...
    num_particles.times do |i|
      ...
      particle2 = addNewSprite(ballX, ballY, "Graphics/Battle animations/#{variances[12]}", PictureOrigin::CENTER)
      particle3 = addNewSprite(ballX, ballY, "Graphics/Battle animations/#{variances[9]}", PictureOrigin::CENTER)
      ...
      [particle2, particle3].each_with_index do |particle, num|
        ...
        elsif ["ballBurst_particle"].include?(variances[12 - (3 * num)])
        ...
        elsif ["ballBurst_dazzle", "circle faded", "shine 3"].include?(variances[12 - (3 * num)])
          particle.moveZoom(delay, particle_duration / 2, 60)
        else
          particle.moveZoom(delay, particle_duration / 2, 100)
        end
        # Zoom out
        if ["ballBurst_particle", "ballBurst_dazzle", "circle wave", "circle faded", "shine 3"].include?(variances[12 - (3 * num)])
    ...
    # Ring particle
    ring = addNewSprite(ballX, ballY, "Graphics/Battle animations/circle 1", PictureOrigin::CENTER)
    ring.setZ(0, 5110)
    ring.setZoom(0, 0)
