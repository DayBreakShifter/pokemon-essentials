...
class Battle::AI
  ...
  BASE_ABILITY_RATINGS = {
    ...
    8  => [:ADAPTABILITY, :AERILATE, :COMMANDER, :CONTRARY, :DISGUISE,
           :DRAGONIZE, :DRAGONSMAW, :GALVANIZE, :GOODASGOLD, :ILLUSION, :LIBERO,
    ...
    4  => [:ANGERPOINT, :BADDREAMS, :CHEEKPOUCH, :CLEARBODY, :CURSEDBODY, :DESERTSPIRIT,
           ...
           :POISONTOUCH, :RIPEN, :SANDFORCE, :SOUNDPROOF, :SPICYSPRAY, :STATIC,
           :SURGESURFER, :SWEETVEIL, :SYNCHRONIZE, :VITALSPIRIT,
           :WATERCOMPACTION, :WATERVEIL, :WHITESMOKE, :WINDRIDER, :WONDERSKIN],
    3  => [:AROMAVEIL, :AURABREAK, :COTTONDOWN, :EMERGENCYEXIT, :GLUTTONY,
           :GULPMISSILE, :HYPERCUTTER, :ICEBODY, :LIMBER, :LIQUIDOOZE,
           :LONGREACH, :MAGICIAN, :MEGASOL, :OWNTEMPO, :PICKPOCKET, :RAINDISH,
           :RATTLED, :SANDVEIL, :SNIPER, :SNOWCLOAK, :SOLARPOWER, :STEAMENGINE,
    ...
    0  => [:ASONECHILLINGNEIGH, :ASONEGRIMNEIGH, :BALLFETCH, :BATTERY,
           ...
           :HONEYGATHER, :MINUS, :PIERCINGDRILL, :PLUS, :POWEROFALCHEMY,
